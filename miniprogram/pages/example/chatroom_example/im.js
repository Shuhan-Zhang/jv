...
Page({
  ...
  addPeople(e) {
    ...
    var chatid1 = that.data.addpeopledetail.openid + app.globalData.openid;
    var chatid2 = app.globalData.openid + that.data.addpeopledetail.openid;
      //如果没有添加该好友
          ...
          if (res.errMsg === "requestSubscribeMessage:ok") {
            wx.cloud.callFunction({
              ...
              data: {
                ...
                addpeopleid: that.data.addpeopledetail.openid, //应该应答请求的那个人
                askpeopleid: app.globalData.openid, //我自己，发出请求的人
                peopleask: app.globalData.userInfo,
                peopleadd: that.data.addpeopledetail.username,
                chatid:
                  that.data.addpeopledetail.openid + app.globalData.openid,
              },
              success: (res) => {
  ...
  peoplepage(e) {
    ...
    wx.navigateTo({
      url:
        "/pages/example/chatroom_example/haoyoupage/haoyoupage?haoyouinfo=" +
        haoyouinfo,
    });
  },
  ...
  itemClick: function (e) {
    ...
    wx.navigateTo({
      url:
        "/pages/example/chatroom_example/room/room?id=chat" +
        index +
        "&name=" +
        "聊天室",
    });
