  ...
  chat(){
      ...
      if(!this.data.backgroundimage1){
        ...
        that.setData({
          ...
          chatname: that.data.haoyouinfo.openid,
          backgroundimage:""
        })
      }
      else{
      ...
      // })
      let  lessonSubId='b0cVrk0vEvthUKTmqt7xV-31wgxUcC-beFDI5N4kkXc'
      //调用订阅消息提醒
      wx.requestSubscribeMessage({
        ...
        success:res => {
         ...
         }else if(res["b0cVrk0vEvthUKTmqt7xV-31wgxUcC-beFDI5N4kkXc"]=="reject"){
